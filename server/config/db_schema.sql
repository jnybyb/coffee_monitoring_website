...
CREATE TABLE IF NOT EXISTS farm_plots (
  plot_id VARCHAR(255) NOT NULL UNIQUE PRIMARY KEY,
...
-- A minimum of 3 points defines a boundary.
-- ==========================================================
...
-- ==========================================================
CREATE TABLE IF NOT EXISTS crop_surveys (
  survey_id INT AUTO_INCREMENT PRIMARY KEY,
  beneficiary_id VARCHAR(255) NOT NULL,
  plot_id VARCHAR(255),
  surveyer_name VARCHAR(150),
  survey_date DATE,
  number_alive INT DEFAULT 0,
...
-- Used for both seedlings and crop survey.
-- ==========================================================
CREATE TABLE IF NOT EXISTS pictures (
  ...
  FOREIGN KEY (plot_id) REFERENCES farm_plots(plot_id)
    ON DELETE CASCADE,
  FOREIGN KEY (survey_id) REFERENCES crop_surveys(survey_id)
    ON DELETE CASCADE,
